...
# this code is to run only frag0&frag1 images in the problem
...
def plot(paths_XYs):
    ...
    # Save the figure
    plt.savefig('frag0_image.png', bbox_inches='tight', pad_inches=0)
...
path1=read_csv('problem/frag0.csv')
plot(path1)

# image processing for correct shapes
image = cv2.imread('frag0_image.png')
...
cv2.imwrite('frag0_corrected_shapes.png', canvas)
cv2.waitKey(0)
